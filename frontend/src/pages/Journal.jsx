    ...
    <div className="flex relative">
      ...
      <main className="md:ml-[260px] p-6 flex-1 bg-gray-50 min-h-screen">
        ...
        {allJournaux.length === 0 ? (
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-700 mb-4"><span className='text-orange-400'>A</span>ll newspapers</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {allJournaux.map(journal => (
                <CardJournal key={journal.id} journal={journal}
                />
              ))}
            </div>
          </div>
