  ...
  return (
    <>
      <button
        ...
        className="md:hidden fixed top-9 right-4 z-50 p-2 cursor-pointer hover:scale-103"
        
      >
      <img src="/src/assets/icons8-hamburger-menu.svg" alt="" className='h-8'/>
      </button>

      <aside
        className={`
          fixed top-0 left-0 h-screen bg-gray-50 shadow-lg border-r border-stone-300 z-40
          w-64
          transform
          transition-transform duration-300
          md:translate-x-0 md:flex md:flex-col md:justify-between sm:w-65
      ...
      >
          ...
          <div className="ml-2 flex flex-col leading-tight">
            <h2 className="text-lg font-semibold">
              <Link to="/dashboard" onClick={() => setIsOpen(false)}>
                <span className="text-orange-400">T</span>rackView
              </Link>
            </h2>
        ...
        <nav className="flex flex-col gap-4 px-5 py-10 flex-grow">
          ...
          <Link to="/trades" className={linkClass('/trades')} onClick={() => setIsOpen(false)}>
          ...
          <Link to="/journals" className={linkClass('/journals')} onClick={() => setIsOpen(false)}>
          ...
          <Link to="/performance" className={linkClass('/performance')} onClick={() => setIsOpen(false)}>
          ...
          <Link to="/account" className={linkClass('/account')} onClick={() => setIsOpen(false)}>
