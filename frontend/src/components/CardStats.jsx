...
function CardStats({title , value , img , currency}) {
  return (
    <div className='bg-gray-400/10 border border-orange-400/50 md:h-35 h-30 md:w-70 my-2 rounded-lg shadow-md shadow-orange-500 duration-200 flex justify-between p-8'>
